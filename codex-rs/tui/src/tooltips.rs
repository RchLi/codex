...
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with Elva.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, Elva is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting Elva.
    ...
    impl TargetOs {
        const fn current() -> Self {
            if cfg!(target_os = "macos") {
                ...
                // Elva currently publishes CLI builds for macOS, Windows, and Linux.
                Self::Linux
            }
        }
    }
...
from_date = "2000-01-01"
    ...
    fn announcement_tip_toml_parse_comments() {
        let toml = r#"
# Example announcement tips for Elva TUI.
...
[[announcements]]
content = "Welcome to Elva! Check out the new onboarding flow."
