//! Captures how this Elva process was launched.
//!
...
/// Builds the process provenance row for the current Elva executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled Elva package.");
    }
    check
}
