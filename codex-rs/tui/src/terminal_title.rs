...
//! "leave the old title alone" or "clear the title Elva last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Elva manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Elva started managing the title.
